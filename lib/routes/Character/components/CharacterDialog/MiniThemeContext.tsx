...
export function useMiniTheme(props: {
  ...
  const miniTheme = useMemo(() => {
    ...
    const helperTextFontSize =
      props.character?.theme?.helperTextFontSize || 0.75;
    ...
    const hideTabBackground =
      props.character?.theme?.hideTabBackground || false;
    ...
    props.character?.theme?.style,
    props.character?.theme?.primaryColor,
    props.character?.theme?.hideTabBackground,
    props.character?.theme?.hideSectionBackground,
    props.character?.theme?.pageHeadingFontFamily,
    props.character?.theme?.pageHeadingFontSize,
    props.character?.theme?.pageHeadingFontWeight,
    props.character?.theme?.sectionHeadingFontFamily,
    props.character?.theme?.sectionHeadingFontSize,
    props.character?.theme?.sectionHeadingFontWeight,
    props.character?.theme?.labelFontFamily,
    props.character?.theme?.labelFontSize,
    props.character?.theme?.labelFontWeight,
    props.character?.theme?.textFontFamily,
    props.character?.theme?.textFontSize,
    props.character?.theme?.textFontWeight,
    props.character?.theme?.helperTextFontFamily,
    props.character?.theme?.helperTextFontSize,
    props.character?.theme?.helperTextFontWeight,
    props.character?.theme?.infoTextFontFamily,
    props.character?.theme?.infoTextFontSize,
    props.character?.theme?.infoTextFontWeight,
  ]);
