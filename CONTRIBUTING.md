...
- **Marketing**: Talk about cassApp on Twitter, Reddit, your personal blog, etc.
- **Bug Reports**: File [bug reports](https://github.com/cassapp/iHunt-app/issues) with detailed information to help us make cassApp more reliable.
- **Feature Requests**: Tell us what you want. Showing that you care about certain issues or features help us triage them.
- **Programming**: If you have a software engineering background, you can help us build the future of cassApp.
- **Financing**: By clicking the "❤️ Sponsor" button on Github, you give us the ability to spend more time enhancing cassApp.
- **Localization**: You can help us [translate cassApp](https://github.com/cassapp/iHunt-app/tree/master/lib/services/internationalization/locales) so that we can reach people from all around the world.
